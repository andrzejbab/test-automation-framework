...
T = TypeVar("T", bound="PatchedAktualnosciThreadUpdate")


@_attrs_define
class PatchedAktualnosciThreadUpdate:
    """
    Attributes:
        title (str | Unset):
        content (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_aktualnosci_thread_update = cls(
            title=title,
            content=content,
            external_link=external_link,
        )

        patched_aktualnosci_thread_update.additional_properties = d
        return patched_aktualnosci_thread_update
