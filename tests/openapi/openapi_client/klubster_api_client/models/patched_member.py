...
class PatchedMember:
    ...
    Attributes:
        ...
        username (str | Unset):
        has_login_account (str | Unset):
        uses_placeholder_email (str | Unset):
        parents (str | Unset):
        parents_details (str | Unset):
    ...
    has_login_account: str | Unset = UNSET
    uses_placeholder_email: str | Unset = UNSET
    parents: str | Unset = UNSET
    parents_details: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if has_login_account is not UNSET:
            field_dict["has_login_account"] = has_login_account
        if uses_placeholder_email is not UNSET:
            field_dict["uses_placeholder_email"] = uses_placeholder_email
        if parents is not UNSET:
            field_dict["parents"] = parents
        if parents_details is not UNSET:
            field_dict["parents_details"] = parents_details
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.has_login_account, Unset):
            files.append(("has_login_account", (None, str(self.has_login_account).encode(), "text/plain")))

        if not isinstance(self.uses_placeholder_email, Unset):
        ...
        if not isinstance(self.parents_details, Unset):
            files.append(("parents_details", (None, str(self.parents_details).encode(), "text/plain")))

        if not isinstance(self.profile_photo_url, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        has_login_account = d.pop("has_login_account", UNSET)

        uses_placeholder_email = d.pop("uses_placeholder_email", UNSET)

        parents = d.pop("parents", UNSET)

        parents_details = d.pop("parents_details", UNSET)
